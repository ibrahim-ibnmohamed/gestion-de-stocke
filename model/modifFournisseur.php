...
if (
    ...
    $req->execute(array(
        ...
        $_POST['telephone'],
        $_POST['adresse'],
        $_POST['id'] // Ajoutez l'ID du fournisseur à mettre à jour

    ));

    if ($req->rowCount() != 0) {
        $_SESSION['message']['text'] = "Fournisseur modifé avec succès.";
        $_SESSION['message']['type'] = 'success';
    } else {
        $_SESSION['message']['text'] = "Erreur : modifecation de Fournisseur a échoué.";
